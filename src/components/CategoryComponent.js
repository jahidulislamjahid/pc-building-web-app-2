    ...
    <div className="flex justify-between items-center group my-3 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50 border">
      <div className=" relative flex items-center gap-x-6 ">
        ...
        <div className="flex-auto">
          ...
          <p className="font-bold text-rose-500 py-2 rounded-full">Required</p>
      ...
      <div>
        {!addedComponent ? (
          <Link
            href={link}
            className="text-xl font-bold py-3 px-6 text-white bg-curiousGreen rounded-md"
          >
            Choose
          </Link>
        ) : (
          <div className="flex justify-center items-center flex-col">
            <p className="text-2xl font-bold p-2 my-2 text-rose-500">
